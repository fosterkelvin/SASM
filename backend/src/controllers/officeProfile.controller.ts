...
export const getProfilesHandler = catchErrors(
...
export const createProfileHandler = catchErrors(
  async (req: Request, res: Response) => {
...
export const selectProfileHandler = catchErrors(
  async (req: Request, res: Response) => {
    ...
    // Set auth cookies using the utility that handles cross-origin correctly
...
export const deleteProfileHandler = catchErrors(
  async (req: Request, res: Response) => {
    const accountID = req.userID;
    appAssert(accountID, UNAUTHORIZED, "Not authenticated");
    const profileID = req.params.id;
...
export const resetProfilePINHandler = catchErrors(
  async (req: Request, res: Response) => {
