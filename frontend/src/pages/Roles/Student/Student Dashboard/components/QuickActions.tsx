...
const QuickActions = () => {
  ...
  return (
    <div className="bg-gradient-to-br from-gray-100 via-white to-gray-200 dark:from-gray-900 dark:via-gray-950 dark:to-gray-900 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700/60 p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <button
          ...
          className="flex items-center gap-3 p-4 bg-red-50 dark:bg-gray-900 hover:bg-red-100 dark:hover:bg-gray-800 rounded-lg transition-colors duration-200 border border-f-200 dark:border-red-700/60 shadow"
        >
          <div className="w-8 h-8 bg-gray-600 dark:bg-gray-700 rounded-lg flex items-center justify-center">
