    ...
    return (
      <div className="flex min-h-screen bg-gradient-to-br from-red-50 via-white to-red-100 dark:from-gray-950 dark:via-gray-900 dark:to-gray-900/80">
        ...
        >
          ...
          <div className="p-6 md:p-10 md:pt-24 flex items-center justify-center min-h-screen">
            <Card className="max-w-2xl w-full mx-4">
              <CardContent className="p-6 md:p-8 text-center">
                <div className="flex flex-col items-center gap-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <p className="text-gray-600 dark:text-gray-400">
                      ...
                      re-applications at this time.
                    </p>
                    <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-4">
                      <div className="text-sm text-red-800 dark:text-red-200">
                        <strong>What this means:</strong>
                        <ul className="list-disc list-inside mt-2 text-left">
                          <li>You cannot submit new re-applications</li>
                          <li>You cannot access re-application forms</li>
                          <li>This restriction was set by HR administration</li>
                        </ul>
                        <br />
